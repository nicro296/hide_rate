...
<br><br>
<a href="https://github.com/nicro296/hide_rate/releases/tag/ver.1.0.2">こちらの最新ver</a>のzipファイルをダウンロード、解凍し以下のサイトなどを参考に拡張機能を有効にしてください。(2Pick Ratingsについては<a href="https://github.com/nicro296/hide_rate#2pick-ratings">こちら</a>)
<br>
